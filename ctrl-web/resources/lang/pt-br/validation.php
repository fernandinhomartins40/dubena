...
return [
    ...
    'attributes' => [
        ...
        'banco_id'                     => 'Banco',
        'pagarreceber'                 => 'Tipo',
        'minimodiasprotesto'           => 'Mín. Dias Protesto',
        'maximodiasprotesto'           => 'Máx. Dias Protesto',
        'boletoposicoesnossonumero'    => 'Posições Nosso Nº',
        'codigo_banco'                 => 'Código do Banco',
        'kmalertaantespneu'            => 'Alerta km antes',
        'minimodiasbaixadevolucao'     => 'Mín. Dias Baixa/Devolução',
        'maximodiasbaixadevolucao'     => 'Máx. Dias Baixa/Devolução',
        'responsavel'                  => 'Responsável',
        'datamovimento'                => 'Movimento Mês/Ano',
        'fornecedor_id'                => 'Fornecedor',
        'suframa'                      => 'Suframa',
        'dias_primeira'                => 'Dias para Pagamento',
        'presencacomprador'            => 'Presença Comprador',
        'msgerroreceita'               => 'Status Sefaz',
        // Representante tecnico | Config Geral
        'rtcnpj'                       => 'CNPJ',
        'rtcontato'                    => 'Nome',
        'rtemail'                      => 'E-Mail',
        'rttelefone'                   => 'Telefone',
        ...
        'fcmtitle'                     => 'Titulo',
        'fcmbody'                      => 'Corpo'
        // Fim Representante tecnico | Config Geral
    ],
];
