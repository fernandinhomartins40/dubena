...
<div id="mainContent" class="content">
    <div id="divCadastro">
        <div class="row">
                                ...
                                <form action="" class="form-horizontal" method="get">
                                    <div class="form-group crud_space">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <button type="button" onclick="window.location.href = '{{route('bairro.index')}}'" id="btnImprimirIframe" class="btn btn-sm btn-github" 
            ...
            <div id='rotaStore' class="hidden">{{route('bairro.store')}}</div>
            <!--Rota para atualizar via ajax-->
            <div id='rotaUpdate' class="hidden">{{url('bairro')}}/</div>
            <!--Rota para deletar via ajax-->
            <div id='rotaDel' class="hidden">{{url('bairro')}}/</div>
            <!--Rota para redirecionar via ajax-->
            <div id='rotaIndex' class="hidden">{{route('bairro.index')}}?{{Request::getQueryString()}}</div>
