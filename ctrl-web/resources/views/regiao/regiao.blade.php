...
<div id="mainContent" class="content">
    <div id="divCadastro">
        <div class="row">
            ...
            <div id='rotaStore' class="hidden">{{route('regiao.store')}}</div>
            <!--Rota para atualizar via ajax-->
            <div id='rotaUpdate' class="hidden">{{url('regiao')}}/</div>
            <!--Rota para deletar via ajax-->
            <div id='rotaDel' class="hidden">{{url('regiao')}}/</div>
            <!--Rota para redirecionar via ajax-->
            <div id='rotaIndex' class="hidden">{{route('regiao.index')}}</div>
