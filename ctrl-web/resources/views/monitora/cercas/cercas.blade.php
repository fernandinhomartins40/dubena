...
<div id="mainContent" class="content">
    <div id="divCadastro">
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6" style="margin-bottom:1%">
                                <a href="{{ URL::route('monitora.cerca.create') }}" class="btn btn-nw-registro">Novo Cadastro</a>
                            </div> <!--col-md-6-->
                        </div> <!--col-md-12-->
                    </div><!--row-->
                                    ...
                                    <tbody id="cercas-list" name="cercas-list">
                                        ...
                                        @if (isset($Cercas) && count($Cercas) > 0)
                                            ...
                                            <tr id="cerca{{$cerca->id}}">
                                                ...
                                                <td>
                                                    <button onclick="window.location.href = '{{route('monitora.cerca.show',$cerca->id)}}'"
                                                        class='btn btn-nw-buscas btn-xs' data-toggle='tooltip' data-trigger="hover" data-placement="bottom" title="Visualizar">
                                                            <span class="fa fa-eye fa-lg"></span>
                                                    </button>
                                                    <button onclick="window.location.href = '{{route('monitora.cerca.edit',$cerca->id)}}'"
            ...
            @include('monitora.general.modal_del')
            <!--Rota para deletar via ajax-->
            <div id='rotaDel' class="hidden">{{url('cerca')}}/</div>
            <div id='rotaIndex' class="hidden">{{route('monitora.cerca.index')}}</div>
        </div><!-- /.content-wrapper -->
    </div>
