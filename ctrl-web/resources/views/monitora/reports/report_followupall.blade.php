@extends('monitora.layouts.report')
...
<table>
  ...
  <tbody>
    @foreach ($contatos as $contato)
        <tr>
          <td class="bordered">{{$contato->empresa->nome_informal}}</td>
          <td class="bordered">{{$contato->aluno->nome}}</td>
          <td class="bordered">{{implode($contato->aluno->telefones->pluck('telefone')->toArray(),', ')}}</td>
          <td class="bordered">{{$contato->descricao}}</td>
          <td class="bordered">{{$contato->aluno->email}}</td>
