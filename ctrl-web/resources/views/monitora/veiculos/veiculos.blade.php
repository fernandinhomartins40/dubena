...
<div id="mainContent" class="content">
    <div id="divCadastro">
        <div class="row">
                            ...
                            <div class="col-md-12">
                                    ...
                                    <tbody id="veiculos-list" name="veiculos-list">
                                        ...
                                        <tr id="veiculo{{$veiculo->id}}">
                                            ...
                                            <td>
                                                <button onclick="window.location.href = '{{route('monitora.veiculo.show',$veiculo->id)}}'"
                                                    class='btn btn-nw-buscas btn-xs' data-toggle='tooltip' data-trigger="hover" data-placement="bottom" title="Visualizar">
                                                        <span class="fa fa-eye fa-lg"></span>
                                                </button>
                                                <button onclick="window.location.href = '{{route('monitora.veiculo.edit',$veiculo->id)}}'"
            ...
            <div id='rotaIndex' class="hidden">{{route('monitora.veiculo.index')}}</div>
        </div><!-- /.content-wrapper -->
    </div>
</div>
@endsection
