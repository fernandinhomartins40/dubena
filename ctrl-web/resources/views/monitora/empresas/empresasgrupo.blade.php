...
<div id="mainContent" class="content">
    <div id="divCadastro">
        <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="col-md-12">
                                <table id="tblCadastro" class="table table-bordered table-hover table-condensed">
                                    <!--{{ route("monitora.empresas_grupo.show", ":id") }}-->
                                    <thead>
                                        <tr>
            ...
            <div id='rotaStore' class="hidden">{{route('monitora.empresas_grupo.store')}}</div>
            ...
            <div id='rotaIndex' class="hidden">{{route('monitora.empresas_grupo.index')}}</div>
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    ...
                    //             $('#ativo_del').prop("checked", $(ativo).text() === 'Sim');
