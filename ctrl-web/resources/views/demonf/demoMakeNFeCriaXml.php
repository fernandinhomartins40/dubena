...
$natOp = 'VENDA MERC SUJ ST RET ANT'; //natureza da operação
...
$nfe->tagCEST(1, '6011000');
// $nfe->tagCEST(2, '100100');
...
//Impostos
$nItem = 1; //produtos 1
$vTotTrib = '20.30'; // 226.80 ICMS + 51.50 ICMSST + 50.40 IPI + 39.36 PIS + 81.84 CONFIS
...
$nItem = 1; //produtos 1
$orig = '0';
$cst = '60'; // Tributado Integralmente
$modBC = '';
$pRedBC = '';
$vBC = '0'; // = $qTrib * $vUnTrib
$pICMS = '0'; // Alíquota do Estado de GO p/ 'NCM 2203.00.00 - Cervejas de Malte, inclusive Chope'
...
$nItem = 1; //produtos 1
$orig = '0';
$cst = '60'; // Tributada e com cobrança do ICMS por substituição tributária
$modBC = '';
$pRedBC = '';
$vBC = '0';
$pICMS = '0'; // Alíquota do Estado de GO p/ 'NCM 2203.00.00 - Cervejas de Malte, inclusive Chope'
...
// $nItem = 1; //produtos 1
// $cst = '00'; // 50 - Saída Tributada (Código da Situação Tributária)
// $clEnq = '';
// $cnpjProd = '';
// $cSelo = '';
// $qSelo = '';
...
$nItem = 1; //produtos 1
$cst = '04'; //Operação Tributável (base de cálculo = quantidade vendida x alíquota por unidade de produto)
$vBC = '';
$pPIS = '';
$vPIS = '0';
$qBCProd = '';
...
// $nItem = 2; //produtos 2
// $cst = '04'; //Operação Tributável (base de cálculo = (valor da operação * alíquota normal) / 100
// $vBC = '180.00';
// $pPIS = '0.6500';
// $vPIS = '2.34';
// $qBCProd = '';
...
$vTotTrib = '20.30';//number_format($vICMS+$vST+$vII+$vIPI+$vPIS+$vCOFINS+$vIOF+$vISS, 2, '.', '');
$resp = $nfe->tagICMSTot($vBC, $vICMS, $vICMSDeson, $vBCST, $vST, $vProd, $vFrete, $vSeg, $vDesc, $vII, $vIPI, $vPIS, $vCOFINS, $vOutro, $vNF, $vTotTrib);
...
// );
$aDup = array(
    array('35342-1','2017-06-20','64.55')
);
foreach ($aDup as $dup) {
