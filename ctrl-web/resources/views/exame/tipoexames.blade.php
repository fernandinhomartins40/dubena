...
<div id="mainContent" class="content">
    <div id="divCadastro">
        <div class="row">
                ...
                <div class="box-header">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6" style="margin-bottom:1%">
                                @can('create', App\Tipoexame::class)
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="box-title">Tipos de Exames</h3>
                        </div><!-- /.box-header -->
                            ...
                            <div class="col-md-12">
                                <table id="tblCadastro" url="" btnClick="false" class="dataTable table table-bordered table-hover table-condensed">
                                  <thead>
                                    ...
                                    <tbody id="-list" name="tipoexames-list">
                                        @foreach ($tipoexames as $tipoexame)
                                        <tr id="tipoexame{{$tipoexame->id}}">
                                            <td>{{$tipoexame->id}}</td>
                                            <td>{{$tipoexame->descricao}}</td>
                                            <td>{{$tipoexame->admissional == 1 ? 'Sim' : 'Não' }}</td>
                                            <td>{{$tipoexame->ativo == 1 ? 'Sim' : 'Não' }}</td>
                                            <td>
                                                @can('view', $tipoexame)
                                                    <button onclick="viewRegister({{$tipoexame}})" 
                                                        class='btn btn-nw-buscas btn-xs' data-toggle='tooltip' data-trigger="hover" data-placement="bottom" title="Visualizar">
                                                            <span class="fa fa-eye fa-lg"></span>
                                                    </button>
                                                @endcan
                                                @can('update', $tipoexame)
                                                    <button onclick="editRegister({{$tipoexame}})" 
                                                        class='btn btn-nw-geral btn-xs' data-toggle='tooltip' data-trigger="hover" data-placement="bottom" title="Editar">
                                                            <span class="fa fa-pencil-square-o fa-lg"></span>
                                                    </button>
                                                @endcan
                                                @can('delete', $tipoexame)
                                                    <button onclick="removeRegister({{$tipoexame}})"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="box-body">
                                ...
                                <div class="form-group crud_space col-sm-12">
                                    <label for="admissional" class="col-sm-2 control-label input-sm required">Admissional:</label>
                                    <div class="col-sm-1 checkbox">
                                        {{ Form::checkbox('admissional', 1, null, ['id'=>'admissional']) }}
                                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="box-body">
                                ...
                                <div class="form-group crud_space col-sm-12">
                                    <label for="admissional_del" class="col-sm-2 control-label input-sm required">Admissional:</label>
                                    <div class="col-sm-1 checkbox">
                                        {{ Form::checkbox('admissional_del', 1, null, ['id'=>'admissional_del']) }}
                                    </div>
                                    <label for="ativo_del" class="col-sm-2 control-label input-sm required">Ativo:</label>
                                    <div class="col-sm-4 checkbox">
            ...
            <div id='rotaStore' class="hidden">{{route('tipoexame.store')}}</div>
            <!--Rota para atualizar via ajax-->
            <div id='rotaUpdate' class="hidden">{{url('tipoexame')}}/</div>
            <!--Rota para deletar via ajax-->
            <div id='rotaDel' class="hidden">{{url('tipoexame')}}/</div>
            <!--Rota para redirecionar via ajax-->
            <div id='rotaIndex' class="hidden">{{route('tipoexame.index')}}</div>
        </div><!-- /.content-wrapper -->
    </div>
</div> 
@endsection
