...
<div id="mainContent" class="content">
    <div id="divCadastro">
        <div class="row">
                ...
                <div class="box-header">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="box-title">Tipos de Usuário</h3>
                        </div><!-- /.box-header -->
                                ...
                                <table id="tblCadastro" class="table table-bordered table-hover table-condensed dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Aparece Usuário</th>
                                            <th>Tipo</th>
                                            <th>Ativo</th>
                                            <th style="width:200px;">Operação</th>
                                        </tr>
                                    </thead>
                                    <tbody id="-list" name="segmentos-list">
                        ...
                        <div class="modal-body">
                            <div class="box-body">
                                ...
                                <div class="form-group crud_space col-sm-12">
                                    ...
                                    <div class="col-sm-5">
                                        {{ Form::select('tipo_id',["1" => "Administrador", "2" => "Alto", "3" => "Baixo"], null,['id'=>'tipo_id','class'=>'selectChosen form-control input-sm']) }}
                                    </div>
                                </div>
                                <div class="form-group crud_space col-sm-12">
                                    ...
                                    <label for="aparece_user" class="col-sm-3 control-label input-sm required">Aparece Usuário:</label>
                                    <div class="col-sm-1 checkbox">
                                        {{ Form::checkbox('aparece_user', 1, null, ['id'=>'aparece_user']) }}
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            </div>        <!--Rota para um novo cadastro via ajax-->
            <div id='rotaStore' class="hidden">{{route('roles.store')}}</div>
            <!--Rota para atualizar via ajax-->
            <div id='rotaUpdate' class="hidden">{{url('roles')}}/</div>
            <!--Rota para deletar via ajax-->
            <div id='rotaDel' class="hidden">{{url('roles')}}/</div>
            <!--Rota para redirecionar via ajax-->
            <div id='rotaIndex' class="hidden">{{route('roles.index')}}</div>
            <!-- page script -->
        </div><!-- /.content-wrapper -->
    </div>
    @endsection
