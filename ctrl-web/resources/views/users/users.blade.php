...
<div id="mainContent" class="content">
    <div id="divCadastro">
        <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6" style="margin-bottom:1%">
                                @can('create', App\User::class)
                                    <a href="{{ URL::route('user.create') }}" class="btn btn-nw-registro btnNwRegistro">Novo Registro</a>
                                @endcan
                            </div> <!--col-md-6-->
                        </div> <!--col-md-12-->
                    </div><!--row-->
                                ...
                                <table id="tblCadastro" class="table table-bordered table-hover table-condensed dataTable">
                                    ...
                                    <tbody id="users-list" name="users-list">
                                        ...
                                        <tr id="user{{$user->id}}">
                                            ...
                                            <td>{{$user->email}}</td>
                                            <td>{{$user->name}}</td>
                                            <td>{{$user->colaborador == null ? '' : $user->colaborador->nome}}</td>
                                            <td>
                                                @can('view', $user)
            ...
            <div id='rotaIndex' class="hidden">{{route('user.index')}}</div>
