        ...
        <div class="row">
            <div class="col-xs-6 col-xs-push-2">
                <div class="box-header">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="box-title">Baixar Vale Gás</h3>
                        </div><!-- /.box-header -->
                        <div class="panel-body">
                            <div class="col-md-12 ">
                                {{ Form::open(['id'=>'fmCadastro', 'route' => 'valegasbaixar.store', 'class' => 'form-horizontal', 'files' => true]) }}
                                ...
                                <div class="crud_space form-group">
                                    ...
                                    <div class="col-md-4 ">
                                        {!! Form::select('situacao', $situacoes, $situacao,['class'=>'selectChosen', 'id' => 'situacao']) !!}
                                    </div>
                                </div>
                                <div class="crud_space form-group">
                                    <div class="col-md-4">
                ...
                <script type="text/javascript">
                    var urlBaixarGB = '{{ url("valegasconsulta?codigo=:codigosituacao=:situacao") }}';
                </script>
                <script src="{{URL::to('js/valegasconsultarBaixar.js')}}"></script>
            </div><!-- /.content-wrapper -->
        </div>
    </div>
</div>
