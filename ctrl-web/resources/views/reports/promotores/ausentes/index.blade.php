            ...
            <div class="box-header">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="box-title">Promotores - Clientes Ausentes</h3>
                    </div>
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="#tab_1" data-toggle="tab">Promotores - Clientes Ausentes</a>
                            </li>
                        </ul>
...
<script type="text/javascript">
    ...
    $("#btnFiltroAusentes").click(function(){
        let url = root + '/report.promoausentes.pdf?datainicio=:datainicio&datafim=:datafim&setor_id=:setor&tipo=1';
        redirect(url, true);
    });

    $("#gerarPdfAusentes").click(function(){
        let url = root + '/report.promoausentes.pdf?datainicio=:datainicio&datafim=:datafim&setor_id=:setor&tipo=2';
        redirect(url, false);
    });
