            ...
            @foreach($convenios as $convenio)
                @if(isset($convenio->totalsetbruto))
                    <tr>
                        ...
                        <th class="bordered destaque money">{{requestNumeroDecimalOracle($convenio->totalsetbruto)}}</th>
                ...
                @elseif(isset($convenio->totalquantidade))
                    ...
                    <tr>
                        <th></th>
                        <th class="bordered destaque align-left" colspan="3">Total Conv.</th>
                        <th class="bordered destaque">{{$convenio->totalquantidade}}</th>
                        <th class="bordered destaque money">{{requestNumeroDecimalOracle($convenio->totalbruto)}}</th>
                        <th class="bordered destaque"></th>
                        <th class="bordered destaque money">{{requestNumeroDecimalOracle($convenio->totalliquido)}}</th>
                        <th></th>
                    </tr>
                ...
                @elseif(isset($convenio->setor))
                    ...
                    <tr>
                        ...
                        <th class="bordered destaque">Conv. Desc.</th>
                        <th class="bordered destaque money">Valor Final</th>
                        <th></th>
                    </tr>
                @elseif(isset($convenio->pedido_id))
                    <tr>
                        ...
                        <td class="bordered money">{{requestNumeroDecimalOracle($convenio->valorbruto)}}</td>
                        <td class="bordered">{{number_format($convenio->desconto,2,',','.')}}%</td>
                ...
                @if ($loop->last)
                    ...
                    <tr>
                        ...
                        <th class="bordered destaque money">{{requestNumeroDecimalOracle($convenio->totalgeralbruto)}}</th>
                        <th class="bordered destaque"></th>
