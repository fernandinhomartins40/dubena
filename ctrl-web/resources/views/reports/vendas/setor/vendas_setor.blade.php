            ...
            <div class="box-header">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="box-title">Vendas por Setores</h3>
                    </div>
                    <!-- /.box-header -->
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group crud_space">
                                                ...
                                                <div class="col-sm-2">
													...
													<button id="btnFiltroVenSetor" type="button" class="btn btn-nw-buscas btn-sm" data-toggle='tooltip' data-trigger="hover" data-placement="bottom" title="Visualizar Relatório"><span class="fa fa-print fa-lg"></span></button>
												</div>
                                            </div>
