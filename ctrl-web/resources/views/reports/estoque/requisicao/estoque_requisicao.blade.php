                ...
                <div class="panel panel-default">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab">Requisições de Estoque</a></li>
                        </ul>
                            ...
                            <div class="tab-pane active" id="tab_1">
                                ...
                                <div class="row">
                                    <div id="tabCadastro" class="col-md-11">
                                        <div class="box-body">
                                            {{ Form::open(['id' => 'reportestoquerequisicao','class'=>'form-horizontal'])}}
                                            <div class="form-group crud_space">
                                                ...
                                                <div class="col-sm-2">
													<button type="button" id='btnLimpar' onclick="window.location.href = '{{route('report.estoquerequisicao')}}'" class="btn btn-sm btn-github" data-toggle='tooltip' data-trigger="hover" data-placement="bottom" title="Limpar"><span class="fa fa-recycle fa-lg"></span></button>
													<button type="button" id='gerarPdfRequisicao' class="btn btn-nw-registro btn-sm" data-toggle='tooltip' data-trigger="hover" data-placement="bottom" title="Gerar PDF"><span class="fa fa-file-pdf-o fa-lg" aria-hidden="true"></span></button>
													<button id="btnFiltroRequisicao" type="button" class="btn btn-nw-buscas btn-sm" data-toggle='tooltip' data-trigger="hover" data-placement="bottom" title="Visualizar Relatório"><span class="fa fa-print fa-lg"></span></button>
												</div>
                                            </div>
                                            <div class="form-group crud_space">
                                                ...
                                                <div id="checkbox">
                                                    {!! Form::label('cancelado', 'Cancelado', ['class'=>'col-md-1 control-label input-sm']) !!}
                                                    <div class="col-md-1 checkbox">
                                                        {!! Form::checkbox('cancelado',0) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
