				...
				<div class="panel panel-default">
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#tab_1" data-toggle="tab">Contas a Receber</a></li>
						</ul>
									...
									<div id="tabCadastro" class="col-sm-12">
										<div class="box-body">
											...
											<div class="form-group crud_space">
												...
												<div class="col-sm-5">
													{{ Form::select('cliente_id',[],null,['id' => 'cliente_id','class'=>'form-control input-sm', 'placeholder' => 'Buscar Cliente', 'data-selectize-value' => '[]']) }}
												</div>
											</div>
											<div class="form-group crud_space">
											...
											<div class="form-group crud_space">
												...
												<div class="col-sm-2 radio">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													...
													<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													{{Form::radio('ordem', 'C' , false)}} <label > Cliente </label>
												</div>
...
<script type="text/javascript">
	...
	function setUrl(callback, pdf) {
		...
		var url = root + '/report.contasreceber';
	...
	$(document).ready(function() {
		...
		$("#cliente_id").selectize({
			...
			load: function (query, callback) {
				...
				var url = root + "/api/searchClientesEmpresaUser/" + empresa_id + "?q=" + query;
