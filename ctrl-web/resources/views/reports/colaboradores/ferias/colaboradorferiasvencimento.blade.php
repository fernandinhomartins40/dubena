            ...
            <div class="box-header">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="box-title">Férias de Colaboradores</h3>
                    </div>
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab">Férias de Colaboradores</a></li>
                        </ul>
                        <!-- /.box-header -->
...
<script type="text/javascript">
    ...
    function setUrl(callback, pdf) {
        ...
        url = root + '/report.colaboradoresferiasvencimento';
