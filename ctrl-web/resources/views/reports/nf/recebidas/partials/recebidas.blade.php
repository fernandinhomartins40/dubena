    ...
    <div id="tabCadastro" class="col-sm-12">
        <div class="box-body">
            <div class="form-group crud_space">
                ...
                {{ Form::label('cliente_id', 'Emitente:', ['class'=>'col-sm-1 control-label input-sm','style'=>'margin-right:8px;']) }}
                <div class="col-sm-4">
                    {{ Form::select('cliente_id',[],null,['id' => 'cliente_id','class'=>'form-control input-sm', 'placeholder' => 'Buscar Emitente', 'data-selectize-value' => '[]']) }}
                </div>
            </div>
            <div class="form-group crud_space">
            ...
            <div class="form-group crud_space"> 
                {{ Form::label('ordem', 'Ordem:', ['class'=>'col-sm-1 control-label input-sm']) }}
                <div class="col-sm-2 radio">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    {{Form::radio('ordem', 'D' , true)}} <label id="ordemData"> Emissão </label>
                    <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    {{Form::radio('ordem', 'O' , false)}} <label > Operação </label>
                    <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    {{Form::radio('ordem', 'E' , false)}} <label > Emitente </label>
                </div>
