        ...
        @foreach($centros as $centro)
            ...
            @elseif(isset($centro->centrocusto_id))
                <tr>
                    ...
                    @if($centro->nivel > 2)
                        @if($centro->link)
                            <td class="bordered  align-left"><a href="{{url('report.receitas_cc.sub')}}?centrocusto={{$centro->centrocusto_id}}&datainicio={{$datainicio}}&datafim={{$datafim}}&hub=1&id={{$empresa}}"
