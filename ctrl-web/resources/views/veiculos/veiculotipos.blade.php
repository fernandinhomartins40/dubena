...
<div id="mainContent" class="content">
    <div id="divCadastro">
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6" style="margin-bottom:1%">
                                @can('create', App\Veiculotipo::class)
                                ...
                                <table id="tblCadastro" class="table table-bordered table-hover table-condensed dataTable">
                                    ...
                                    <tbody id="-list" name="veiculotipos-list">
                                        ...
                                        <tr id="veiculotipo{{$veiculotipo->id}}">
                                            ...
                                            <td>
                                                @if(isset($tipos))
                                                    @if(!empty($veiculotipo->tiporastreamento))
                                                        {{$tipos[$veiculotipo->tiporastreamento]}}
                                                    @else
                                                        Veículo
                                                    @endif
                                                @else
            ...
            <div id='rotaStore' class="hidden">{{route('veiculotipo.store')}}</div>
            ...
            <div id='rotaIndex' class="hidden">{{route('veiculotipo.index')}}</div>
