...
class CreateProdutoCategoriaImportacoesTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('sgcm_api')->create('produtocategoriaimportacoes', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
    ...
    {
        Schema::connection('sgcm_api')->dropIfExists('produtocategoriaimportacoes');
    }
}
