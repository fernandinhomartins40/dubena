...
class CreateNfrecebidasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('nfrecebidas', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->boolean('inutilizarcancelar')->default(false)->nullable()->default(null);
            ...
            $table->foreign('fretefinanceiro_id', 'nferec_financeiros_foreign')->references('id')->on('financeiros');
            $table->foreign('planoconta_id')->references('id')->on('planocontas');
            $table->foreign('centrocusto_id')->references('id')->on('centrocustos');
            $table->foreign('freteplanoconta_id', 'nferec_planocontas_foreign')->references('id')->on('planocontas');
            $table->foreign('fretecentrocusto_id', 'nferec_centrocustos_foreign')->references('id')->on('centrocustos');
            $table->foreign('setor_id')->references('id')->on('setors');
            $table->foreign('user_id')->references('id')->on('users');
            $table->foreign('fretecliente_id', 'nferec_clientes_foreign')->references('id')->on('clientes');
            $table->foreign('condicaopagamento_id', 'nferec_condpag_foreign')->references('id')->on('condicaopagamentos');
            $table->foreign('nfsituacaoanterior_id', 'nferec_nfsituacaos_foreign')->references('id')->on('nfsituacaos');
        });
    }
