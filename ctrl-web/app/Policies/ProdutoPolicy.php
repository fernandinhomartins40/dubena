...
class ProdutoPolicy
{
    ...
    public function igualdade(User $user, Produto $produto)
    {
        $permissoes = $this->getPermissoes();
        ...
        $empresa = $produto->empresa_id == $this->empresa_id;
    ...
    {
        return $this->permissoes->where('descricao','produto.index')->first();
    }
}
