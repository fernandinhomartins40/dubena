            ...
            $nf = Nfemitida::from('nfemitidas as p')
                ...
                ->selectRaw(
                    "	ID , NFOPERACAO_ID, CHAVEACESSO , CHAVEACESSODV , CFOP , DESCRICAOOPERACAO , FORMAPAGAMENTO, NFMODELO , NFSERIE , NFNUMERO ," .
                        ...
                        " NVL(INFORMACAOCOMPLEMENTAR, '') AS INFORMACAOCOMPLEMENTAR, NVL(INFORMACAOADICIONALFISCO, '') AS INFORMACAOADICIONALFISCO, CLIENTE_ID ,CODCNF ,CODCDV ,CODCRT ,NITEM ,VBC ,VICMS ,VBCST ,VST ,VPROD ,VFRETE ,VSEG ,VDESC ,VII ,VIPI ,VPIS ,VCOFINS ,VOUTRO ,VNF ,NFSITUACAO_ID ,FINANCEIRO_ID ,FRETEFINANCEIRO_ID ,PLANOCONTA_ID ,CENTROCUSTO_ID ,FRETEPLANOCONTA_ID ,FRETECENTROCUSTO_ID ,USER_ID ,FRETECLIENTE_ID ,CONDICAOPAGAMENTO_ID ,VBCFUNRURAL ,VPFUNRURAL ,VFUNRURAL ,EMISSAO ,DESCRICAOFINANCEIRO,DATAHORAAUTORIZACAO,EMITTELEFONE ,DESTTELEFONE ,NUMERORECIBOENVIO ,PLANOCONTADESCRICAO,NATUREZASPED ,NVL(DESTIE, '') AS DESTIE , VFCPSTRET,VFCPST,VICMSUFREMET,VICMSUFDEST,VFCPUFDEST,VICMSDESON,VFCP,DESCRICAOSITUACAO,NFC_TPAG,IDDEST ,INDFINAL, XMLRETORNO, PROTOCOLO, XMLRETORNOCOMPLETO "
                )->get();
