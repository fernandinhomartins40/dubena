...
use Eduardokum\LaravelBoleto\Boleto\Banco\Itau as Itau;


class BoletoItauService extends Itau
{
    /*
    ...
    */
    ...
    public function getProperties(){
        $ret = (object) get_object_vars($this);
        $ret->beneficiario = $this->beneficiario->toArray();
        $ret->pagador = $this->pagador->toArray();
        return $ret;
    }
}