...
use App\Monitora\Models\Cercapoligono;
...
class Cercacontroller extends controller
{
    ...
    public function index()
    {
        ...
        return view('monitora.cercas.cercas', compact('Cercas'));
    }
    ...
    public function create()
    {
        ...
        return view('monitora.cercas.cerca_form', compact('setors', 'latlng', 'cercas', 'keygooglemaps'));
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::commit();
        return \Redirect::route('monitora.cerca.index')->withMessageSuccess('Cerca cadastrada com sucesso!');
    }
    ...
    public function show($id)
    {
        ...
        return view('monitora.cercas.cerca_form', compact('Cerca', 'show', 'setors', 'latlng', 'cercas', 'keygooglemaps'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('monitora.cercas.cerca_form', compact('Cerca', 'setors', 'latlng', 'cercas', 'keygooglemaps'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::commit();
        return \Redirect::route('monitora.cerca.index')->withMessageSuccess('Cerca atualizada com sucesso!');        
    }
