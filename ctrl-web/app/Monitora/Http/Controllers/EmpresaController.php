...
class Empresacontroller extends controller {
  ...
  */
  public function index() {
    ...
    return view('monitora.empresas.empresas', compact('Empresas'));
  }
  ...
  */
  public function create() {
    ...
    return view('monitora.empresas.empresa_form', compact('grupos'));
  }
  ...
  */
  public function show($id) {
    ...
    $grupos = EmpresasGrupo::where('ativo', true)->orderBy('descricao')->pluck('descricao', 'id');
    $show = true;
    return view('monitora.empresas.empresa_form', compact('Empresa', 'show', 'grupos'));
  }
  ...
  */
  public function edit($id) {
    $Empresa = Empresa::find($id);
    $grupos = EmpresasGrupo::where('ativo', true)->orderBy('descricao')->pluck('descricao', 'id');
    return view('monitora.empresas.empresa_form', compact('Empresa', 'grupos'));
  }
  ...
  */
  public function destroy($id) {
    ...
    try {
      ...
      DB::rollback();
      return \Redirect::route('monitora.empresa.index')->withMessageDanger('<br /><br />O registro não pôde ser excluído pois está sendo usado!');
    }
    DB::commit();
    return \Redirect::route('monitora.empresa.index');
  }

  public function form(Request $request) {
    $EmpresasGrupo = EmpresasGrupo::all();
    return view('monitora.empresas.empresasgrupo_form', compact('EmpresasGrupo'));
  }
