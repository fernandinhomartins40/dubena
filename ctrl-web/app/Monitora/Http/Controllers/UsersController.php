...
class UsersController extends Controller
{
    ...
    {
        $users = User::all();
        return view('monitora.users.users', compact('users'));
    }

    public function indexchangepassword()
    {
        $User = \Auth::guard('monitora')->user();
        return view('monitora.users.changepassword', compact('User'));
    }
    ...
    public function create()
    {
        ...
        return view('monitora.users.user_form', compact('empresas', 'empresaslnk', 'menus', 'menuslnk'));
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::commit();
        return \Redirect::route('monitora.user.index')->withMessageSuccess('Usuário cadastrado com sucesso!');
    }
    
    public function validateUserSupport($data)
    {
        if (\Auth::guard('monitora')->user()->support)
    ...
    public function show($id)
    {
        ...
        $show = true;
        return view('monitora.users.user_form', compact('oauthClient', 'user', 'empresas', 'empresaslnk', 'menus', 'menuslnk', 'show'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('monitora.users.user_form', compact('user', 'empresas', 'empresaslnk', 'menus', 'menuslnk'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::commit();
        return \Redirect::route('monitora.user.index')->withMessageSuccess('Usuário atualizado com sucesso!');
    }
    ...
    public function updatepassword(Request $request, $id)
    {
        try {
            ...
            */
            $data['password'] = bcrypt($data['password']);
            $User->update($data);
            return \Redirect::route('monitora.home');
        } catch (\Exception $e) {
...
//    return \Redirect::route('monitora.user.index');
    }

    public function home()
    {
        return view('monitora.users.home');
    }
