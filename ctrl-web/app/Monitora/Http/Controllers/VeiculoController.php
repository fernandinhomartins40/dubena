...
use App\Monitora\Models\Device;
...
class VeiculoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('monitora.veiculos.veiculos', compact('veiculos'));
    }
    ...
    public function create()
    {
        ...
        return view('monitora.veiculos.veiculo_form', compact('veiculotipos'));
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::commit();
        return \Redirect::route('monitora.veiculo.index')->withMessageSuccess('Veículo cadastrado com sucesso!');
    }
    ...
    public function show($id)
    {
        ...
        $veiculotipos = Veiculotipo::orderBy('descricao')->pluck('descricao', 'id');
        $show = true;
        return view('monitora.veiculos.veiculo_form', compact('veiculo', 'show', 'veiculotipos'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('monitora.veiculos.veiculo_form', compact('veiculo', 'veiculotipos'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::commit();
        return \Redirect::route('monitora.veiculo.index')->withMessageSuccess('Veículo atualizado com sucesso!');
    }
