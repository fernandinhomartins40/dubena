...
class RegD590 extends AbstractReg
{
    ...
    protected function getValidationArray()
    {
        return [
            ...
            'VL_BC_ICMS_UF' => static::getBaseVR("Parcela correspondente ao valor da base de cálculo do ICMS de outras UFs"),
            'VL_ICMS_UF'    => static::getBaseVR("Valor do ICMS ST"),
