 ...
 */
class Reg1100 extends AbstractReg
{
    /**
    ...
    protected function setAttributes($data = [])
    {
        ...
        $whereRaw = "per_apu_cred BETWEEN TO_DATE('$datainicio', 'yyyy-mm-dd') AND TO_DATE('$datafim', 'yyyy-mm-dd') "
                . "AND registro = '1100' AND empresa_id = $empresa_id";
        ...
        foreach ($uniqueItems as $uItem) {
            ...
            $this->VL_CRED_APU = Util::numberFormat($sumVpis);
            $this->VL_TOT_CRED_APU = Util::numberFormat($sumVpis);
            $this->SD_CRED_DISP_EFD = Util::numberFormat($sumVpis);
            $this->SLD_CRED_FIM = Util::numberFormat($sumVpis);
    ...
    protected function getValidationArray()
    {
        return [
            ...
            'VL_CRED_APU'           => static::getBaseVR("Valor total do crédito apurado na Escrituração Fiscal Digital (Registro M100)", false),
            ...
            'VL_CRED_DCOMP_PA_ANT'  => static::getBaseVR("Valor do Crédito utilizado mediante Declaração de Compensação Intermediária (Crédito de Exportação)", false, false, "N"),
            ...
            'VL_CRED_PER_EFD'       => static::getBaseVR("Valor do Crédito objeto de Pedido de Ressarcimento (PER)", false, false, "N"),
            ...
            'SLD_CRED_FIM'          => static::getBaseVR("Saldo de créditos a utilizar em período de apuração futuro", false, false, "N")
        ];
    }
}