...
class RegC501 extends AbstractReg
{
    ...
    protected function getValidationArray()
    {
        return [
            ...
            'VL_BC_PIS'     => static::getBaseVR("Valor da base de cálculo do PIS/PASEP", false),
            'ALIQ_PIS'      => static::getBaseVR("Alíquota do PIS/PASEP (em percentual)", 8),
