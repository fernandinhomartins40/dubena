...
(function($){$.extend({progressBar:new function(){this.defaults={steps:20,step_duration:20,max:100,showText:true,textFormat:'percentage',width:120,height:12,callback:null,boxImage:'_images/progressbar/progressbar.gif',barImage:{0:'_images/progressbar/progressbg_green.gif',40:'_images/progressbar/progressbg_orange.gif',70:'_images/progressbar/progressbg_red.gif'},running_value:0,text_value:0,value:0,image:null};this.construct=function(arg1,arg2){var argvalue=null;var argconfig=null;if(arg1!=null){if(!isNaN(arg1)){argvalue=arg1;if(arg2!=null){argconfig=arg2;}}else{argconfig=arg1;}}
...
return image;}
function getText(config){if(config.showText){if(config.textFormat=='percentage'){return" "+Math.round(config.text_value)+" RPM";}else if(config.textFormat=='fraction'){return" "+config.running_value+'/'+config.max;}}}
