	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '_images/progressbar/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0: '_images/progressbar/progressbg_green.gif',
									40: '_images/progressbar/progressbg_orange.gif',
									70:	'_images/progressbar/progressbg_red.gif'
								},
					...
					function getText(config) {
						if (config.showText) {
							if (config.textFormat == 'percentage') {
								return " " + Math.round(config.text_value) + " RPM";
