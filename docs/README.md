...
1. [01-vigente/PLANO_SPA_REACT.md](01-vigente/PLANO_SPA_REACT.md) — plano vigente (fases S1–S8).
2. [01-vigente/MAPA_NAVEGACAO_ALVO.md](01-vigente/MAPA_NAVEGACAO_ALVO.md) — como as telas dispersas
   do legado se reorganizam em páginas completas (de-para; reorganizar ≠ eliminar).
3. [01-vigente/IMPL_00_INDICE.md](01-vigente/IMPL_00_INDICE.md) — PRDs de implementação por módulo
