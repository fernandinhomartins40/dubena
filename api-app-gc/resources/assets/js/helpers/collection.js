...
if (! Array.prototype.has) {
    Array.prototype.has = function (index, value, strict) {
        let operator = _getOperatorForStrict(strict);
...
let _uniqueFunction = function (index, elements, strict) {
    let items = [];
...
let _whereFunction = function (index, operator, value, collection, has) {
...
let _getOperatorForStrict = function (strict){
    return !strict ? "==" : "===";
};