...
return [
    ...
    'minwords'             => "O campo :attribute deve ter no mínimo :minwords palavras.",
    /*
      |--------------------------------------------------------------------------
    ...
    'custom' => [
        ...
        'nome'              => [
            'regex'     => 'O formato do Nome é inválido, use somente letras.'
        ]
    ],
    /*
      |--------------------------------------------------------------------------
    ...
    'attributes' => [
        ...
        'telefone'                      => 'Telefone',
        'titulo'                        => 'Título',
        'keygooglemaps'                 => 'Key API Google Maps',
        'cliente_id'                    => 'Cliente',
        'condicaopagamento_id'          => 'Condição de Pagamento',
        'produtosJson'                  => 'Json Produtos',
        ...
        'data'                          => 'Data',
        'descricao'                     => 'Descrição',
        'pushregistration_id'           => 'Token de Notificações Push',
        'tipo'                          => 'Tipo',
    ],
];
